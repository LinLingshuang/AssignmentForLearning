...
void PlayerUI::setWood(int wood)
{
    this->wood = wood;
    updateSglBar(WOOD);
}

void PlayerUI::setStone(int stone)
{
    this->stone = stone;
    updateSglBar(STONE);
}

void PlayerUI::setGold(int gold)
{
    this->gold = gold;
    updateSglBar(GOLD);
}

void PlayerUI::setCampHealth(int campHealth)
{
    this->campHealth = campHealth;
    updateSglBar(CAMPHEALTH);
}
