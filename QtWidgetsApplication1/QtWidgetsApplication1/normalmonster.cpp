...
//----monster3----
Slime::Slime(QGraphicsItem* parent):Monster(MonsterType::SLIME,parent){
    Slime::loadAnimationFrames();
    Slime::loadAttackFrames();
    Slime::loadDeathFrames();
    initializeMonster();
}

void Slime::loadAnimationFrames(){
    animationFrames.clear();
    // 定义动画帧文件路径
    QStringList frameFiles;
    frameFiles << ":/picture/slime/(1).png"
               << ":/picture/slime/(2).png"
               << ":/picture/slime/(3).png"
               << ":/picture/slime/(4).png";
...
void Slime::loadAttackFrames(){
    attackFrames.clear();
    // 定义动画帧文件路径
    QStringList frameFiles;
    frameFiles << ":/picture/slime/(5).png"
               << ":/picture/slime/(6).png"
               << ":/picture/slime/(7).png"
               << ":/picture/slime/(8).png";
...
void Slime::loadDeathFrames()
{
    deathFrames.clear();

    QStringList deathFrameFiles;
    deathFrameFiles << ":/picture/slime/(9).png"
                    << ":/picture/slime/(10).png"
                    << ":/picture/slime/(11).png"
                    << ":/picture/slime/(12).png";
