    ...
    currentFrameIndex(0)            // 动画帧索引从0开始
{
    ...
    case MonsterType::SLIME:
        monsterHealth = SLIME_HEALTH;
        monsterSpeed  = SLIME_SPEED;
        monsterGold   = SLIME_GOLD;
        attackDamage  = SLIME_DAMAGE;
        break;
...
void Monster::showDamageEffect(float damage)
{
    ...
    QGraphicsTextItem* damageText =
        new QGraphicsTextItem(QString::number(int(damage)), safeThis);
